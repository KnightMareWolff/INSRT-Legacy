...
CICLPlataforma::CICLPlataforma(cl_platform_id pICL_PlatformID, QString pICL_DefaultGPUVendor)
{
    cl_int  ICL_Error;
...
void CICLPlataforma::execDevice(IGLVertexBuffer *pICL_Buffer, uint pICL_BufferSize, CIMTMatriz *pICL_Transform)
{
    //Inicializa a lista de Devices da plataforma construindo a partir do ID do Device
    for(uint i=0; i<ICL_QtdDevices;i++ )
    {
...
void CICLPlataforma::execDevice(uint pICL_BufferId, uint pICL_BufferSize, CIMTMatriz *pICL_Transform)
{
    //Inicializa a lista de Devices da plataforma construindo a partir do ID do Device
    for(uint i=0; i<ICL_QtdDevices;i++ )
    {
...
int CICLPlataforma::CountDevicesByType(int pICL_DeviceType)
{
    int tICL_Count = 0;
...
bool CICLPlataforma::VerificaGPUPrimaria()
{
...
bool CICLPlataforma::VerificaGPUSecundaria()
{
    bool tICL_DefaultGPU   = false;
    bool tICL_InteropDev   = false;
...
bool CICLPlataforma::VerificaCPUAuxiliar()
{
