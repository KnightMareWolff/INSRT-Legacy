...
CICLPrograma::~CICLPrograma()
{
    clReleaseProgram(ICL_ProgramID);
}

CICLPrograma::CICLPrograma(cl_context pICL_DeviceContext, cl_device_id pICL_DeviceID, QString pICL_FileName)
{
...
CICLKernel* CICLPrograma::PegaKernelPorNome(QString pICL_Nome)
{
