...
public:
    ...
    ~CICLDevice(                                                                                       );
     ...
     void          execPgm     (IGLVertexBuffer *pICL_Buffer  , uint pICL_BufferSize, CIMTMatriz *pICL_Transform);
     void          execPgm     (uint             pICL_BufferId, uint pICL_BufferSize, CIMTMatriz *pICL_Transform);

     uint          PegaTpDevice        (                                                  );
     CICLPrograma* PegaProgramaPorNome (QString pICL_Nome                                 );
...
private:
    ...
    vector<CICLPrograma*>   ICL_Programas;
