...
CIGLFunctionsIOS::CIGLFunctionsIOS(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
...
bool CIGLFunctionsIOS::iglEnableStates()
{
...
bool CIGLFunctionsIOS::iglDisableStates()
{
...
bool CIGLFunctionsIOS::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsIOS::iglBegin(unsigned int estado)
{
...
bool CIGLFunctionsIOS::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsIOS::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsIOS::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsIOS::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsIOS::iglRenderBuffers(int          vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsIOS::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsIOS::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsIOS::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsIOS::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsIOS::iglSetaLuzPonto     (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsIOS::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsIOS::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsIOS::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsIOS::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsIOS::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsIOS::iglSetaUniformInt(GLchar *nome,int vlr)
{
...
bool CIGLFunctionsIOS::iglSetaUniformVec3(GLchar *nome,CIMTVetor vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(pShader->programId(),nome);
...
bool CIGLFunctionsIOS::iglSetaUniformVec4(GLchar *nome,CIMTVetor4 vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(pShader->programId(),nome);
...
bool CIGLFunctionsIOS::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsIOS::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsIOS::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsIOS::iglInitBuffers( VertexData   *VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsIOS::BindBuffers(GLuint *Id)
{
    /****************************************************************/
...
void CIGLFunctionsIOS::TransfFeedback(long           QtdVertices    ,
                                          long           QtdIndices     ,
                                          FeedBackData  *FeedbackBuffer )
{
    /*************************************************************************/
...
void CIGLFunctionsIOS::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsIOS::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsIOS::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsIOS::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   pShader->AddPgm(pi3dNomeShader,pShaderType);
   return true;
}

bool CIGLFunctionsIOS::iglCompile()
{
   /*******************************************************/
...
bool CIGLFunctionsIOS::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                        int           IdLuz          ,
                                        bool          bHabilita      )
{
...
bool CIGLFunctionsIOS::iglColormaterial(bool bHabilita)
{
...
bool CIGLFunctionsIOS::iglTextureST(bool bHabilita)
{
...
bool CIGLFunctionsIOS::iglQuads()
{
...
bool CIGLFunctionsIOS::iglPolygons()
{
