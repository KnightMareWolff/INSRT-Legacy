#ifndef IGL_FUNCTIONSPCV12_H
#define IGL_FUNCTIONSPCV12_H
...
class CIGLFunctionsPCv12 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv12(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_1_2  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV12_H
