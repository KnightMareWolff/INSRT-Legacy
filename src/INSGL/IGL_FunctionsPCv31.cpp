#include "IGL_FunctionsPCv31.h"

#ifdef Q_OS_WIN

CIGLFunctionsPCv31::CIGLFunctionsPCv31(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
...
bool CIGLFunctionsPCv31::iglEnableStates()
{
...
bool CIGLFunctionsPCv31::iglDisableStates()
{
...
bool CIGLFunctionsPCv31::iglActiveTexture(unsigned int estado)
{
    qWarning() << "Função iglActiveTexture Não é utilizada em versoes anteriores a 1.3.";
    return false;
}

bool CIGLFunctionsPCv31::iglBegin(unsigned int estado)
{
    pGL->glBegin( estado );
    return true;
}

bool CIGLFunctionsPCv31::iglEnd()
{
    pGL->glEnd();
    return true;
}

bool CIGLFunctionsPCv31::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv31::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv31::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv31::iglDeleteBuffers(int vlr, GLuint *Id)
{
    qWarning() << "Função iglDeleteBuffers Não é utilizada em versoes anteriores a 1.5.";
    return false;
}

bool CIGLFunctionsPCv31::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsPCv31::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsPCv31::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv31::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv31::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsPCv31::iglSetaLuzPonto       (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsPCv31::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv31::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv31::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsPCv31::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsPCv31::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    CIMTMatriz Look;
...
bool CIGLFunctionsPCv31::iglSetaUniformInt(GLchar *nome,int vlr)
{
    qWarning() << "Função iglSetaUniformInt Não Suportado por versoes anteriores a 3.1.";
    return false;
}

bool CIGLFunctionsPCv31::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    qWarning() << "Função iglSetaUniformMatrix Não Suportado por versoes anteriores a 2.0.";
    return false;
}

bool CIGLFunctionsPCv31::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv31::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv31::iglInitBuffers( VertexData   *VertexBuffer  ,
...
bool CIGLFunctionsPCv31::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsPCv31::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsPCv31::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   return false;
}

bool CIGLFunctionsPCv31::iglCompile()
{
   return false;
}

bool CIGLFunctionsPCv31::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                      int           IdLuz          ,
                                      bool          bHabilita      )
{
...
bool CIGLFunctionsPCv31::iglColormaterial(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv31::iglTextureST(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv31::iglQuads()
{
    iglBegin(GL_QUADS);
    return true;
}

bool CIGLFunctionsPCv31::iglPolygons()
{
    iglBegin(GL_POLYGON);
    return true;
}
