#ifndef IGL_FUNCTIONSPCV40_H
#define IGL_FUNCTIONSPCV40_H
...
class CIGLFunctionsPCv40 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv40(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
