...
CIGLFunctionsPCv43::CIGLFunctionsPCv43(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
...
bool CIGLFunctionsPCv43::iglEnableStates()
{
...
bool CIGLFunctionsPCv43::iglDisableStates()
{
...
bool CIGLFunctionsPCv43::iglFenceSync(GLsync &pIGL_Sync)
{
   pIGL_Sync = pGL->glFenceSync(GL_SYNC_GPU_COMMANDS_COMPLETE,0);
   return true;
}

bool CIGLFunctionsPCv43::iglWaitSync(GLsync pIGL_Sync)
{
   pGL->glWaitSync(pIGL_Sync,0,0);
   return true;
}

bool CIGLFunctionsPCv43::iglFinish()
{
   pGL->glFinish();
   return true;
}

bool CIGLFunctionsPCv43::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsPCv43::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv43::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv43::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv43::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv43::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint         ProgramId     ,
                                          GLuint        *Id            ,
                                          ...
                                          FeedBackData  *FeedbackBuffer)
{
    ...
    else
    {
        ...
        BindBuffers(ProgramId,Id,false);
...
bool CIGLFunctionsPCv43::iglSetaMaterial(GLuint ProgramId,
...
bool CIGLFunctionsPCv43::iglSetaLuzPonto       (GLuint ProgramId,
                                                unsigned int Id                 ,
                                                CIMTVetor4   pos                ,
                                                CIMTVetor4   dir                ,
                                                CIMTVetor4   CorDifusa          ,
...
bool CIGLFunctionsPCv43::iglSetaLuzDirecional  (GLuint ProgramId,
                                                unsigned int Id          ,
                                                CIMTVetor4 pos           ,
                                                CIMTVetor4 dir           ,
                                                CIMTVetor4 CorDifusa     ,
...
bool CIGLFunctionsPCv43::iglSetaLuzSpot        (GLuint ProgramId,
                                                unsigned int Id         ,
                                                CIMTVetor4  pos         ,
                                                CIMTVetor4 dir          ,
                                                CIMTVetor4 CorDifusa    ,
...
bool CIGLFunctionsPCv43::iglSetaVisPerspectiva(GLuint ProgramId,
                                               float  ValorProx   ,
                                               float  ValorDist   ,
                                               int    ValorAltura ,
                                               int    ValorLargura,
...
bool CIGLFunctionsPCv43::iglSetaVisOrtogonal(GLuint ProgramId,
                                             float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
...
bool CIGLFunctionsPCv43::iglSetaLookAt(GLuint ProgramId, CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsPCv43::iglSetaUniformInt(GLuint ProgramId,const GLchar *nome,int vlr)
{
...
bool CIGLFunctionsPCv43::iglSetaUniformFloat(GLuint ProgramId,const GLchar *nome,float vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv43::iglSetaUniformVec3(GLuint ProgramId,const GLchar *nome,CIMTVetor  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv43::iglSetaUniformVec4(GLuint ProgramId,const GLchar *nome,CIMTVetor4  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv43::iglSetaUniformMatrix(GLuint ProgramId, CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsPCv43::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
    mIGLPVMMatrix = mtx * (mIGLViewMatrix * mIGLProjectionMatrix);
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv43::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv43::iglInitBuffers(IGLVertexBuffer *IGL_VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsPCv43::BindBuffers(GLuint ProgramId,GLuint *Id,bool Feedback)
{
...
void CIGLFunctionsPCv43::TransfFeedback(long           QtdVertices    ,
                                        long           QtdIndices     ,
                                        FeedBackData  *FeedbackBuffer )
{
    GLuint query;
    pGL->glGenQueries(1, &query);


    pGL->glBeginTransformFeedback(IGL_RENDER_POINTS);
    pGL->glBeginQuery(GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN, query);
    ...
    pGL->glFlush();
    pGL->glEndQuery(GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN);

    GLuint primitives;
    pGL->glGetQueryObjectuiv(query, GL_QUERY_RESULT, &primitives);
...
void CIGLFunctionsPCv43::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsPCv43::iglColormaterial(GLuint ProgramId,bool bHabilita)
{
    /*****************************************************************************/
...
bool CIGLFunctionsPCv43::iglMaterialMode(GLuint ProgramId,int iMode)
{
    /*****************************************************************************/
    /*Em Shaders Não temos a Limitação de ColorMaterial mutuamente exclusiva com */
    /*As Luzes e Materiais                                                       */
...
bool CIGLFunctionsPCv43::iglReadPixels(int x, int y, GLchar *res)
{
    GLint viewport[4];
...
bool CIGLFunctionsPCv43::iglFrontFace(int iMode)
{
    pGL->glFrontFace(iMode);
    return true;
}

int CIGLFunctionsPCv43::iglGetVersion()
{
    if(bIGLContextoInicializado)
    {
        return iIGLVersion;
...
bool CIGLFunctionsPCv43::iglCreateTexture(GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv43::iglCreateCubeMap  (GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv43::iglPreparaTextura(GLuint     IGL_TextureId     ,
...
bool CIGLFunctionsPCv43::iglTransformFeedback(GLuint IGL_ProgramId)
{
    pGL->glTransformFeedbackVaryings(IGL_ProgramId,1, tf_varyings, GL_INTERLEAVED_ATTRIBS);
    return true;
}

bool CIGLFunctionsPCv43::iglTransformBuffer(GLuint IGL_ProgramId, GLuint IGL_VboId, GLuint IGL_QtdVertices, CIMTMatriz IGL_TransfMtx, IGLVertexBuffer *IGL_VertexData)
{
...
IGLVertexBuffer * CIGLFunctionsPCv43::iglMapBuffer(GLuint  IGL_ProgramId,
                                                   GLuint  IGL_VboId    )
{
    IGLVertexBuffer *pVertex   = 0;
...
bool CIGLFunctionsPCv43::iglUnMapBuffer(GLuint           IGL_ProgramId,
                                        GLuint           IGL_VboId    ,
...
QString CIGLFunctionsPCv43::iglGetString(GLuint           IGL_StringId)
{
