...
CIGLFunctionsPCv40::CIGLFunctionsPCv40(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    iIGLMinorVersion = iMajor ;
    iIGLMajorVersion = iMinor ;

    pGL = pContext->versionFunctions<QOpenGLFunctions_4_0_Core>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv40::iglEnableStates()
{
...
bool CIGLFunctionsPCv40::iglDisableStates()
{
...
bool CIGLFunctionsPCv40::iglFenceSync(GLsync &pIGL_Sync)
{
   pIGL_Sync = pGL->glFenceSync(GL_SYNC_GPU_COMMANDS_COMPLETE,0);
   return true;
}

bool CIGLFunctionsPCv40::iglWaitSync(GLsync pIGL_Sync)
{
   pGL->glWaitSync(pIGL_Sync,0,0);
   return true;
}

bool CIGLFunctionsPCv40::iglFinish()
{
   pGL->glFinish();
   return true;
}

bool CIGLFunctionsPCv40::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsPCv40::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv40::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv40::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv40::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv40::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint         ProgramId     ,
                                          GLuint        *Id            ,
...
bool CIGLFunctionsPCv40::iglSetaMaterial(GLuint ProgramId,
...
bool CIGLFunctionsPCv40::iglSetaLuzPonto       (GLuint ProgramId,
                                                unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
                                                CIMTVetor4   CorDifusa,
...
bool CIGLFunctionsPCv40::iglSetaLuzDirecional  (GLuint ProgramId,
                                                unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
...
bool CIGLFunctionsPCv40::iglSetaLuzSpot        (GLuint ProgramId,
                                                unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
...
bool CIGLFunctionsPCv40::iglSetaVisPerspectiva(GLuint ProgramId   ,
                                               float  ValorProx   ,
                                               float  ValorDist   ,
                                               int    ValorAltura ,
                                               int    ValorLargura,
...
bool CIGLFunctionsPCv40::iglSetaVisOrtogonal(GLuint ProgramId,
                                             float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
...
bool CIGLFunctionsPCv40::iglSetaLookAt(GLuint ProgramId,CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsPCv40::iglSetaUniformInt(GLuint ProgramId,const GLchar *nome,int vlr)
{
...
bool CIGLFunctionsPCv40::iglSetaUniformFloat(GLuint ProgramId,const GLchar *nome,float vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv40::iglSetaUniformVec3(GLuint ProgramId,const GLchar *nome,CIMTVetor  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv40::iglSetaUniformVec4(GLuint ProgramId,const GLchar *nome,CIMTVetor4  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv40::iglSetaUniformMatrix(GLuint ProgramId,CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsPCv40::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv40::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv40::iglInitBuffers(IGLVertexBuffer *IGL_VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsPCv40::BindBuffers(GLuint ProgramId,GLuint *Id)
{
...
void CIGLFunctionsPCv40::TransfFeedback(long           QtdVertices    ,
                                        long           QtdIndices     ,
                                        FeedBackData  *FeedbackBuffer )
{
...
void CIGLFunctionsPCv40::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsPCv40::iglColormaterial(GLuint ProgramId, bool          bHabilita      )
{
    /*****************************************************************************/
...
bool CIGLFunctionsPCv40::iglMaterialMode(GLuint ProgramId,int iMode)
{
    /*****************************************************************************/
    /*Em Shaders Não temos a Limitação de ColorMaterial mutuamente exclusiva com */
    /*As Luzes e Materiais                                                       */
...
bool CIGLFunctionsPCv40::iglReadPixels(int x, int y, GLchar *res)
{
    GLint viewport[4];
...
bool CIGLFunctionsPCv40::iglFrontFace(int iMode)
{
    pGL->glFrontFace(iMode);
    return true;
}

int CIGLFunctionsPCv40::iglGetVersion()
{
    if(bIGLContextoInicializado)
    {
        return iIGLVersion;
...
bool CIGLFunctionsPCv40::iglCreateTexture(GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv40::iglCreateCubeMap  (GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv40::iglPreparaTextura(GLuint     IGL_TextureId     ,
...
bool CIGLFunctionsPCv40::iglTransformFeedback(GLuint IGL_ProgramId)
{
