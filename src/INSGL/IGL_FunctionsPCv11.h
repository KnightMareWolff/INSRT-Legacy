#ifndef IGL_FUNCTIONSPCV11_H
#define IGL_FUNCTIONSPCV11_H
...
class CIGLFunctionsPCv11 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv11(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_1_1  *pGL;
};
#endif
#endif // IGL_FUNCTIONSPCV11_H
