...
CIGLFunctionsPCv41::CIGLFunctionsPCv41(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    iIGLMinorVersion = iMajor ;
    iIGLMajorVersion = iMinor ;

    pGL = pContext->versionFunctions<QOpenGLFunctions_4_1_Core>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv41::iglEnableStates()
{
...
bool CIGLFunctionsPCv41::iglDisableStates()
{
...
bool CIGLFunctionsPCv41::iglFenceSync(GLsync &pIGL_Sync)
{
   pIGL_Sync = pGL->glFenceSync(GL_SYNC_GPU_COMMANDS_COMPLETE,0);
   return true;
}

bool CIGLFunctionsPCv41::iglWaitSync(GLsync pIGL_Sync)
{
   pGL->glWaitSync(pIGL_Sync,0,0);
   return true;
}

bool CIGLFunctionsPCv41::iglFinish()
{
   pGL->glFinish();
   return true;
}
...
bool CIGLFunctionsPCv41::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsPCv41::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv41::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv41::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv41::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv41::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint         ProgramId     ,
                                          GLuint        *Id            ,
...
bool CIGLFunctionsPCv41::iglSetaMaterial(GLuint ProgramId,
...
bool CIGLFunctionsPCv41::iglSetaLuzPonto       (GLuint ProgramId,
                                                unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
                                                CIMTVetor4   CorDifusa,
...
bool CIGLFunctionsPCv41::iglSetaLuzDirecional  (GLuint ProgramId,
                                                unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
...
bool CIGLFunctionsPCv41::iglSetaLuzSpot        (GLuint ProgramId,
                                                unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
...
bool CIGLFunctionsPCv41::iglSetaVisPerspectiva(GLuint  ProgramId   ,
                                               float   ValorProx   ,
                                               float   ValorDist   ,
                                               int     ValorAltura ,
                                               int     ValorLargura,
...
bool CIGLFunctionsPCv41::iglSetaVisOrtogonal(GLuint  ProgramId ,
                                             float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
...
bool CIGLFunctionsPCv41::iglSetaLookAt(GLuint  ProgramId ,CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsPCv41::iglSetaUniformInt(GLuint ProgramId,const GLchar *nome,int vlr)
{
...
bool CIGLFunctionsPCv41::iglSetaUniformFloat(GLuint ProgramId,const GLchar *nome,float vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv41::iglSetaUniformVec3(GLuint ProgramId,const GLchar *nome,CIMTVetor  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv41::iglSetaUniformVec4(GLuint ProgramId,const GLchar *nome,CIMTVetor4  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv41::iglSetaUniformMatrix(GLuint  ProgramId ,CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsPCv41::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv41::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv41::iglInitBuffers(IGLVertexBuffer *IGL_VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsPCv41::BindBuffers(GLuint ProgramId,GLuint *Id)
{
...
void CIGLFunctionsPCv41::TransfFeedback(long           QtdVertices    ,
                                        long           QtdIndices     ,
                                        FeedBackData  *FeedbackBuffer )
{
...
void CIGLFunctionsPCv41::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsPCv41::iglColormaterial(GLuint ProgramId, bool          bHabilita      )
{
    /*****************************************************************************/
...
bool CIGLFunctionsPCv41::iglMaterialMode(GLuint ProgramId,int iMode)
{
    /*****************************************************************************/
    /*Em Shaders Não temos a Limitação de ColorMaterial mutuamente exclusiva com */
    /*As Luzes e Materiais                                                       */
...
bool CIGLFunctionsPCv41::iglReadPixels(int x, int y, GLchar *res)
{
    GLint viewport[4];
...
bool CIGLFunctionsPCv41::iglFrontFace(int iMode)
{
    pGL->glFrontFace(iMode);
    return true;
}

int CIGLFunctionsPCv41::iglGetVersion()
{
    if(bIGLContextoInicializado)
    {
        return iIGLVersion;
...
bool CIGLFunctionsPCv41::iglCreateTexture(GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv41::iglCreateCubeMap  (GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv41::iglPreparaTextura(GLuint     IGL_TextureId     ,
...
bool CIGLFunctionsPCv41::iglTransformFeedback(GLuint IGL_ProgramId)
{
