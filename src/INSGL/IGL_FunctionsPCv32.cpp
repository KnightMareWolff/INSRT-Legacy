#include "IGL_FunctionsPCv32.h"

#ifdef Q_OS_WIN

CIGLFunctionsPCv32::CIGLFunctionsPCv32(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    ...
    pGL = pContext->versionFunctions<QOpenGLFunctions_3_2_Compatibility>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv32::iglEnableStates()
{
...
bool CIGLFunctionsPCv32::iglDisableStates()
{
...
bool CIGLFunctionsPCv32::iglActiveTexture(unsigned int estado)
{
    qWarning() << "Função iglActiveTexture Não é utilizada em versoes anteriores a 1.3.";
    return false;
}

bool CIGLFunctionsPCv32::iglBegin(unsigned int estado)
{
    pGL->glBegin( estado );
    return true;
}

bool CIGLFunctionsPCv32::iglEnd()
{
    pGL->glEnd();
    return true;
}

bool CIGLFunctionsPCv32::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv32::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv32::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv32::iglDeleteBuffers(int vlr, GLuint *Id)
{
    qWarning() << "Função iglDeleteBuffers Não é utilizada em versoes anteriores a 1.5.";
    return false;
}

bool CIGLFunctionsPCv32::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsPCv32::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsPCv32::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv32::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv32::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsPCv32::iglSetaLuzPonto       (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsPCv32::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv32::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv32::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsPCv32::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsPCv32::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    CIMTMatriz Look;
...
bool CIGLFunctionsPCv32::iglSetaUniformInt(GLchar *nome,int vlr)
{
    qWarning() << "Função iglSetaUniformInt Não Suportado por versoes anteriores a 3.1.";
    return false;
}

bool CIGLFunctionsPCv32::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    qWarning() << "Função iglSetaUniformMatrix Não Suportado por versoes anteriores a 2.0.";
    return false;
}

bool CIGLFunctionsPCv32::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv32::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv32::iglInitBuffers( VertexData   *VertexBuffer  ,
...
bool CIGLFunctionsPCv32::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsPCv32::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsPCv32::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   return false;
}

bool CIGLFunctionsPCv32::iglCompile()
{
   return false;
}

bool CIGLFunctionsPCv32::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                      int           IdLuz          ,
                                      bool          bHabilita      )
{
...
bool CIGLFunctionsPCv32::iglColormaterial(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv32::iglTextureST(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv32::iglQuads()
{
    iglBegin(GL_QUADS);
    return true;
}

bool CIGLFunctionsPCv32::iglPolygons()
{
    iglBegin(GL_POLYGON);
    return true;
}
