#ifndef IGL_FUNCTIONSPCV10_H
#define IGL_FUNCTIONSPCV10_H
...
class CIGLFunctionsPCv10 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv10(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_1_0  *pGL;
};
#endif
#endif // IGL_FUNCTIONSPCV10_H
