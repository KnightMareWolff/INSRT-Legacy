#ifndef IGL_FUNCTIONSPCV41_H
#define IGL_FUNCTIONSPCV41_H
...
class CIGLFunctionsPCv41 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv41(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
    ...
    bool iglSetaVisOrtogonal   (GLuint ProgramId, float ValorProx,
                                float ValorDist,
                                int   ValorAltura,
                                int   ValorLargura);
