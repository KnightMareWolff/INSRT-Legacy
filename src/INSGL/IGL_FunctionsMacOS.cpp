...
CIGLFunctionsMacOS::CIGLFunctionsMacOS(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    ...
    if(pContext->isValid())
    {
       ...
       pGL->initializeOpenGLFunctions();
    }
}

bool CIGLFunctionsMacOS::iglEnableStates()
{
...
bool CIGLFunctionsMacOS::iglDisableStates()
{
...
bool CIGLFunctionsMacOS::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsMacOS::iglBegin(unsigned int estado)
{
...
bool CIGLFunctionsMacOS::iglEnd()
{
...
bool CIGLFunctionsMacOS::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsMacOS::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsMacOS::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsMacOS::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsMacOS::iglRenderBuffers(int          vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsMacOS::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsMacOS::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsMacOS::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsMacOS::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsMacOS::iglSetaLuzPonto     (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsMacOS::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsMacOS::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsMacOS::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsMacOS::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsMacOS::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsMacOS::iglSetaUniformInt(GLchar *nome,int vlr)
{
...
bool CIGLFunctionsMacOS::iglSetaUniformVec3(GLchar *nome,CIMTVetor vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(pShader->programId(),nome);
...
bool CIGLFunctionsMacOS::iglSetaUniformVec4(GLchar *nome,CIMTVetor4 vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(pShader->programId(),nome);
...
bool CIGLFunctionsMacOS::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsMacOS::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsMacOS::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsMacOS::iglInitBuffers( VertexData   *VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsMacOS::BindBuffers(GLuint *Id)
{
    /****************************************************************/
...
void CIGLFunctionsMacOS::TransfFeedback(long           QtdVertices    ,
                                          long           QtdIndices     ,
                                          FeedBackData  *FeedbackBuffer )
{
    /*************************************************************************/
...
void CIGLFunctionsMacOS::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsMacOS::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsMacOS::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsMacOS::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   pShader->AddPgm(pi3dNomeShader,pShaderType);
   return true;
}

bool CIGLFunctionsMacOS::iglCompile()
{
   /*******************************************************/
...
bool CIGLFunctionsMacOS::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                        int           IdLuz          ,
                                        bool          bHabilita      )
{
...
bool CIGLFunctionsMacOS::iglColormaterial(bool bHabilita)
{
...
bool CIGLFunctionsMacOS::iglTextureST(bool bHabilita)
{
...
bool CIGLFunctionsMacOS::iglQuads()
{
...
bool CIGLFunctionsMacOS::iglPolygons()
{
