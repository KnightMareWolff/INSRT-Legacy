#ifndef IGL_FUNCTIONSMACOS_H
#define IGL_FUNCTIONSMACOS_H
...
class CIGLFunctionsMacOS : public CIGLFunctions
{
public:
    CIGLFunctionsMacOS(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
    ...
    bool iglSetaUniformVec3    (GLchar *nome,CIMTVetor  vlr);
    bool iglSetaUniformVec4    (GLchar *nome,CIMTVetor4 vlr);
...
private:
    ...
    QOpenGLFunctions           *pGL;
    INSSH                      *pShaderControl;
    CISHProgram                *pShader;

    void BindBuffers(GLuint *Id);
