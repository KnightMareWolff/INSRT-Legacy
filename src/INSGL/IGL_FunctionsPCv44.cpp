...
CIGLFunctionsPCv44::CIGLFunctionsPCv44(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    iIGLMinorVersion = iMajor ;
    iIGLMajorVersion = iMinor ;

    pGL = pContext->versionFunctions<QOpenGLFunctions_4_4_Core>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv44::iglEnableStates()
{
...
bool CIGLFunctionsPCv44::iglDisableStates()
{
...
bool CIGLFunctionsPCv44::iglFenceSync(GLsync &pIGL_Sync)
{
   pIGL_Sync = pGL->glFenceSync(GL_SYNC_GPU_COMMANDS_COMPLETE,0);
   return true;
}

bool CIGLFunctionsPCv44::iglWaitSync(GLsync pIGL_Sync)
{
   pGL->glWaitSync(pIGL_Sync,0,0);
   return true;
}

bool CIGLFunctionsPCv44::iglFinish()
{
   pGL->glFinish();
   return true;
}
...
bool CIGLFunctionsPCv44::iglActiveTexture(unsigned int estado)
{
    pGL->glActiveTexture( estado );
    return true;
}

bool CIGLFunctionsPCv44::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv44::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv44::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv44::iglDeleteBuffers(int vlr, GLuint *Id)
{
    pGL->glDeleteBuffers(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv44::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint         ProgramId     ,
                                          GLuint        *Id            ,
...
bool CIGLFunctionsPCv44::iglSetaMaterial(GLuint ProgramId,
...
bool CIGLFunctionsPCv44::iglSetaLuzPonto       (GLuint ProgramId,
                                                unsigned int Id                 ,
                                                CIMTVetor4   pos                ,
                                                CIMTVetor4   dir                ,
                                                CIMTVetor4   CorDifusa          ,
...
bool CIGLFunctionsPCv44::iglSetaLuzDirecional  (GLuint ProgramId,
                                                unsigned int Id          ,
                                                CIMTVetor4 pos           ,
                                                CIMTVetor4 dir           ,
                                                CIMTVetor4 CorDifusa     ,
...
bool CIGLFunctionsPCv44::iglSetaLuzSpot        (GLuint ProgramId,
                                                unsigned int Id         ,
                                                CIMTVetor4  pos         ,
                                                CIMTVetor4 dir          ,
                                                CIMTVetor4 CorDifusa    ,
...
bool CIGLFunctionsPCv44::iglSetaVisPerspectiva(GLuint ProgramId,
                                               float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
...
bool CIGLFunctionsPCv44::iglSetaVisOrtogonal(GLuint ProgramId,
                                             float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
...
bool CIGLFunctionsPCv44::iglSetaLookAt(GLuint ProgramId,CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    int view_location;
...
bool CIGLFunctionsPCv44::iglSetaUniformInt(GLuint ProgramId,const GLchar *nome,int vlr)
{
...
bool CIGLFunctionsPCv44::iglSetaUniformFloat(GLuint ProgramId,const GLchar *nome,float vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv44::iglSetaUniformVec3(GLuint ProgramId,const GLchar *nome,CIMTVetor  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv44::iglSetaUniformVec4(GLuint ProgramId,const GLchar *nome,CIMTVetor4  vlr)
{
    int uniform_location;
    uniform_location=pGL->glGetUniformLocation(ProgramId,nome);
...
bool CIGLFunctionsPCv44::iglSetaUniformMatrix(GLuint ProgramId, CIMTMatriz mtx)
{
    int model_location;
...
bool CIGLFunctionsPCv44::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv44::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv44::iglInitBuffers(IGLVertexBuffer *IGL_VertexBuffer  ,
...
/*************************************/
void CIGLFunctionsPCv44::BindBuffers(GLuint ProgramId,GLuint *Id)
{
...
void CIGLFunctionsPCv44::TransfFeedback(long           QtdVertices    ,
                                        long           QtdIndices     ,
                                        FeedBackData  *FeedbackBuffer )
{
...
void CIGLFunctionsPCv44::RenderBuffers(int TpPoligono, long QtdIndices)
{
    switch(TpPoligono)
    {
...
bool CIGLFunctionsPCv44::iglColormaterial(GLuint ProgramId,bool bHabilita)
{
    /*****************************************************************************/
...
bool CIGLFunctionsPCv44::iglMaterialMode(GLuint ProgramId,int iMode)
{
    /*****************************************************************************/
    /*Em Shaders Não temos a Limitação de ColorMaterial mutuamente exclusiva com */
    /*As Luzes e Materiais                                                       */
...
bool CIGLFunctionsPCv44::iglReadPixels(int x, int y, GLchar *res)
{
    GLint viewport[4];
...
bool CIGLFunctionsPCv44::iglFrontFace(int iMode)
{
    pGL->glFrontFace(iMode);
    return true;
}

int CIGLFunctionsPCv44::iglGetVersion()
{
    if(bIGLContextoInicializado)
    {
        return iIGLVersion;
...
bool CIGLFunctionsPCv44::iglCreateTexture(GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv44::iglPreparaTextura(GLuint     IGL_TextureId     ,
...
bool CIGLFunctionsPCv44::iglCreateCubeMap  (GLuint        &IGL_TextureId     ,
...
bool CIGLFunctionsPCv44::iglTransformFeedback(GLuint IGL_ProgramId)
{
    pGL->glTransformFeedbackVaryings(IGL_ProgramId,1, tf_varyings, GL_INTERLEAVED_ATTRIBS);
    return true;
}

bool CIGLFunctionsPCv44::iglTransformBuffer(GLuint IGL_ProgramId, GLuint IGL_VboId, GLuint IGL_QtdVertices, CIMTMatriz IGL_TransfMtx, IGLVertexBuffer *IGL_VertexData)
{
...
IGLVertexBuffer * CIGLFunctionsPCv44::iglMapBuffer(GLuint  IGL_ProgramId,
                                                   GLuint  IGL_VboId    )
{
    IGLVertexBuffer *pVertex   = 0;
...
bool CIGLFunctionsPCv44::iglUnMapBuffer(GLuint           IGL_ProgramId,
                                        GLuint           IGL_VboId    ,
...
QString CIGLFunctionsPCv44::iglGetString(GLuint           IGL_StringId)
{
