#ifndef IGL_FUNCTIONSPCV44_H
#define IGL_FUNCTIONSPCV44_H
...
class CIGLFunctionsPCv44 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv44(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
