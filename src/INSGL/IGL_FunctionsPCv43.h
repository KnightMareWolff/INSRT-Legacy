#ifndef IGL_FUNCTIONSPCV43_H
#define IGL_FUNCTIONSPCV43_H
...
class CIGLFunctionsPCv43 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv43(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    ...
    void BindBuffers(GLuint ProgramId, GLuint *Id, bool Feedback);
