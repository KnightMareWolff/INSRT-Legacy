#include "IGL_FunctionsPCv13.h"

#ifdef Q_OS_WIN

CIGLFunctionsPCv13::CIGLFunctionsPCv13(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    ...
    pGL = pContext->versionFunctions<QOpenGLFunctions_1_3>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv13::iglEnableStates()
{
...
bool CIGLFunctionsPCv13::iglDisableStates()
{
...
bool CIGLFunctionsPCv13::iglActiveTexture(unsigned int estado)
{
    qWarning() << "Função iglActiveTexture Não é utilizada em versoes anteriores a 1.3.";
    return false;
}

bool CIGLFunctionsPCv13::iglBegin(unsigned int estado)
{
    pGL->glBegin( estado );
    return true;
}

bool CIGLFunctionsPCv13::iglEnd()
{
    pGL->glEnd();
    return true;
}

bool CIGLFunctionsPCv13::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv13::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv13::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv13::iglDeleteBuffers(int vlr, GLuint *Id)
{
    qWarning() << "Função iglDeleteBuffers Não é utilizada em versoes anteriores a 1.5.";
    return false;
}

bool CIGLFunctionsPCv13::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsPCv13::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsPCv13::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv13::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv13::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsPCv13::iglSetaLuzPonto       (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsPCv13::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv13::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv13::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsPCv13::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsPCv13::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    CIMTMatriz Look;
...
bool CIGLFunctionsPCv13::iglSetaUniformInt(GLchar *nome,int vlr)
{
    qWarning() << "Função iglSetaUniformInt Não Suportado por versoes anteriores a 3.1.";
    return false;
}

bool CIGLFunctionsPCv13::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    qWarning() << "Função iglSetaUniformMatrix Não Suportado por versoes anteriores a 2.0.";
    return false;
}

bool CIGLFunctionsPCv13::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv13::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv13::iglInitBuffers( VertexData   *VertexBuffer  ,
...
bool CIGLFunctionsPCv13::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsPCv13::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsPCv13::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   return false;
}

bool CIGLFunctionsPCv13::iglCompile()
{
   return false;
}

bool CIGLFunctionsPCv13::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                      int           IdLuz          ,
                                      bool          bHabilita      )
{
...
bool CIGLFunctionsPCv13::iglColormaterial(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv13::iglTextureST(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv13::iglQuads()
{
    iglBegin(GL_QUADS);
    return true;
}

bool CIGLFunctionsPCv13::iglPolygons()
{
    iglBegin(GL_POLYGON);
    return true;
}
