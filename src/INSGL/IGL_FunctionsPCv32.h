#ifndef IGL_FUNCTIONSPCV32_H
#define IGL_FUNCTIONSPCV32_H
...
class CIGLFunctionsPCv32 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv32(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_3_2_Compatibility  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV32_H
