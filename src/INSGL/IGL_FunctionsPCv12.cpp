#include "IGL_FunctionsPCv12.h"

#ifdef Q_OS_WIN

CIGLFunctionsPCv12::CIGLFunctionsPCv12(QOpenGLContext *pContext, int iVersao, int iMajor, int iMinor)
{
    iIGLVersion      = iVersao;
    ...
    pGL = pContext->versionFunctions<QOpenGLFunctions_1_2>();
    if (!pGL)
    {
...
bool CIGLFunctionsPCv12::iglEnableStates()
{
...
bool CIGLFunctionsPCv12::iglDisableStates()
{
...
bool CIGLFunctionsPCv12::iglActiveTexture(unsigned int estado)
{
    qWarning() << "Função iglActiveTexture Não é utilizada em versoes anteriores a 1.3.";
    return false;
}

bool CIGLFunctionsPCv12::iglBegin(unsigned int estado)
{
    pGL->glBegin( estado );
    return true;
}

bool CIGLFunctionsPCv12::iglEnd()
{
    pGL->glEnd();
    return true;
}

bool CIGLFunctionsPCv12::iglEnable(unsigned int estado)
{
    pGL->glEnable( estado );
    return true;
}

bool CIGLFunctionsPCv12::iglDisable(unsigned int estado)
{
    pGL->glDisable( estado );
    return true;
}

bool CIGLFunctionsPCv12::iglDeleteTextures(int vlr, GLuint *Id)
{
    pGL->glDeleteTextures(vlr,Id);
    return true;
}

bool CIGLFunctionsPCv12::iglDeleteBuffers(int vlr, GLuint *Id)
{
    qWarning() << "Função iglDeleteBuffers Não é utilizada em versoes anteriores a 1.5.";
    return false;
}

bool CIGLFunctionsPCv12::iglRenderBuffers(int            vlr           ,
                                          long           QtdVertices   ,
                                          long           QtdIndices    ,
                                          GLuint        *Id            ,
                                          GLuint        *FbId          ,
...
bool CIGLFunctionsPCv12::iglRenderVertice(CIMTVetor vertice,
                                          CIMTVetor normal ,
                                          bool Autotexture ,
                                          bool Multitextura,
                                          float tu         ,
...
bool CIGLFunctionsPCv12::iglAutoTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv12::iglMultiTexture(float S[], float T[])
{
...
bool CIGLFunctionsPCv12::iglSetaMaterial(CIMTVetor4 CorDifusa  ,
...
bool CIGLFunctionsPCv12::iglSetaLuzPonto       (unsigned int Id ,
                                                CIMTVetor4   pos,
                                                CIMTVetor4   dir,
...
bool CIGLFunctionsPCv12::iglSetaLuzDirecional  (unsigned int Id,
                                                CIMTVetor4 pos ,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv12::iglSetaLuzSpot        (unsigned int Id,
                                                CIMTVetor4  pos,
                                                CIMTVetor4 dir,
                                                CIMTVetor4 CorDifusa,
                                                CIMTVetor4 CorAmbiente,
...
bool CIGLFunctionsPCv12::iglSetaVisPerspectiva(float ValorProx   ,
                                               float ValorDist   ,
                                               int   ValorAltura ,
                                               int   ValorLargura,
                                               float FOV         )
...
bool CIGLFunctionsPCv12::iglSetaVisOrtogonal(float ValorProx,
                                             float ValorDist,
                                             int   ValorAltura,
                                             int   ValorLargura)
{
...
bool CIGLFunctionsPCv12::iglSetaLookAt(CIMTVetor Pos, CIMTVetor View, CIMTVetor Up)
{
    CIMTMatriz Look;
...
bool CIGLFunctionsPCv12::iglSetaUniformInt(GLchar *nome,int vlr)
{
    qWarning() << "Função iglSetaUniformInt Não Suportado por versoes anteriores a 3.1.";
    return false;
}

bool CIGLFunctionsPCv12::iglSetaUniformMatrix(CIMTMatriz mtx)
{
    qWarning() << "Função iglSetaUniformMatrix Não Suportado por versoes anteriores a 2.0.";
    return false;
}

bool CIGLFunctionsPCv12::iglCalculaPVMMatrix(CIMTMatriz mtx,CIMTMatriz &resmtx)
{
...
bool CIGLFunctionsPCv12::iglPegaPVMMatrix(CIMTMatriz &resmtx)
{
    resmtx = mIGLPVMMatrix;
    return true;
}

bool CIGLFunctionsPCv12::iglInitBuffers( VertexData   *VertexBuffer  ,
...
bool CIGLFunctionsPCv12::iglSuportaShaders()
{
   return bIGLSuportaShaders;
}

bool CIGLFunctionsPCv12::iglSuportaFeedback()
{
   return bIGLSuportaFeedback;
}

bool CIGLFunctionsPCv12::iglAddShader(QString pi3dNomeShader, int pShaderType)
{
   return false;
}

bool CIGLFunctionsPCv12::iglCompile()
{
   return false;
}

bool CIGLFunctionsPCv12::iglPegaIdLuz(GLenum       &ThisGLLight    ,
                                      int           IdLuz          ,
                                      bool          bHabilita      )
{
...
bool CIGLFunctionsPCv12::iglColormaterial(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv12::iglTextureST(bool bHabilita)
{
    if(bHabilita)
    {
...
bool CIGLFunctionsPCv12::iglQuads()
{
    iglBegin(GL_QUADS);
    return true;
}

bool CIGLFunctionsPCv12::iglPolygons()
{
    iglBegin(GL_POLYGON);
    return true;
}
