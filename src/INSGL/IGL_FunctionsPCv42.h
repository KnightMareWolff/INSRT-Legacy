#ifndef IGL_FUNCTIONSPCV42_H
#define IGL_FUNCTIONSPCV42_H
...
class CIGLFunctionsPCv42 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv42(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
    ...
    bool iglSetaVisPerspectiva (GLuint ProgramId, float ValorProx,
                                float ValorDist,
                                int   ValorAltura,
                                int   ValorLargura,
                                float FOV);
...
public:
    ...
    void AddShader    (QString pi3dNomeShader, int pShaderType);
    void Compile      (                                       );
};

#endif
#endif // IGL_FUNCTIONSPCV42_H
