#ifndef IGL_FUNCTIONSPCV31_H
#define IGL_FUNCTIONSPCV31_H
...
class CIGLFunctionsPCv31 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv31(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_3_0  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV31_H
