#ifndef IGL_FUNCTIONSPCV15_H
#define IGL_FUNCTIONSPCV15_H
...
class CIGLFunctionsPCv15 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv15(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_1_5  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV15_H
