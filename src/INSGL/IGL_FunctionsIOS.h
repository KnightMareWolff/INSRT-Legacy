#ifndef IGL_FUNCTIONSIOS_H
#define IGL_FUNCTIONSIOS_H
...
class CIGLFunctionsIOS : public CIGLFunctions
{
public:
    CIGLFunctionsIOS(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
