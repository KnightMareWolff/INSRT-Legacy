#ifndef IGL_FUNCTIONSPCV21_H
#define IGL_FUNCTIONSPCV21_H
...
class CIGLFunctionsPCv21 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv21(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_2_1  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV21_H
