#ifndef IGL_FUNCTIONSPCV20_H
#define IGL_FUNCTIONSPCV20_H
...
class CIGLFunctionsPCv20 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv20(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_2_0  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV20_H
