#ifndef IGL_FUNCTIONSPCV30_H
#define IGL_FUNCTIONSPCV30_H
...
class CIGLFunctionsPCv30 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv30(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
