#ifndef IGL_FUNCTIONSANDROID_H
#define IGL_FUNCTIONSANDROID_H
...
class CIGLFunctionsAndroid : public CIGLFunctions
{
public:
    CIGLFunctionsAndroid(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
