#ifndef IGL_FUNCTIONSPCV33_H
#define IGL_FUNCTIONSPCV33_H
...
class CIGLFunctionsPCv33 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv33(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_3_3_Compatibility  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV33_H
