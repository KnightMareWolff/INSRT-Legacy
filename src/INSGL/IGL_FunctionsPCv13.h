#ifndef IGL_FUNCTIONSPCV13_H
#define IGL_FUNCTIONSPCV13_H
...
class CIGLFunctionsPCv13 : public CIGLFunctions
{
public:
    CIGLFunctionsPCv13(QOpenGLContext *pContext,int iVersao,int iMajor,int iMinor);
...
private:
    QOpenGLFunctions_1_3  *pGL;
};

#endif
#endif // IGL_FUNCTIONSPCV13_H
