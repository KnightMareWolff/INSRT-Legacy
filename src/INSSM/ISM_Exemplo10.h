...
/*Descricao           :Exemplo de Utilização de Render to Texture                 */
/*Data de Criação     :                                                           */
/*                                                                                */
/*Copyright (c) 2013 William Wolff. Todos os direitos reservados                  */
/**********************************************************************************/
#ifndef CISMEXEMPLO10_H
#define CISMEXEMPLO10_H

#include "ISM_Cenario.h"
#include "IUT_Lista.h"

class CISMExemplo10 : public CISMCenario
{
private:
    CI3DCamera                      *pCam          ;//Camera principal de visualização
    CI3DLuz                         *pLuzAmbiente  ;//Luz Ambiente
    CI3DCubo                        *pSky          ;//SkyBox
    CIMDVideo                       *pVideoAvi     ;//Video em Arquivo
    CIMDVideo                       *pVideoCamera  ;//Video extraido da Webcam
    CIMDSom                         *pSom          ;//Som Executado em 3D
...
public:
     CISMExemplo10(QOpenGLContext   *pI3DContext);
     CISMExemplo10(QGLContext       *pI3DContext);
    ~CISMExemplo10(                             );
