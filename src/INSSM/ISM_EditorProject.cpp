...
CISMEditorProject::CISMEditorProject(QOpenGLContext *pI3DContext):
...
CISMEditorProject::CISMEditorProject(QGLContext *pI3DContext):
    CISMCenario(pI3DContext)
{
    japosicionou          =false;
...
CISMEditorProject::~CISMEditorProject()
{
    delete pCubo;
}

bool CISMEditorProject::Inicializa()
{
...
bool CISMEditorProject::Resize(int w, int h)
{
    /*****************************/
...
bool CISMEditorProject::MapeiaMouse(int x, int y)
{
    pCam->MapeiaMouse((float)x ,(float)y);
    return true;
}

bool CISMEditorProject::MoverCamera(int pAction)
{
    /****************************************/
...
bool CISMEditorProject::InputKey(int pKey)
{
    /****************************************/
    /*Processa as teclas pressionadas       */
    /****************************************/
...
bool CISMEditorProject::SetIniPos(CI3DCamera *pCam, CIMTVetor centro)
{
    CIMTVetor posicao;
...
bool CISMEditorProject::AtualizaCena()
{
    /******************************************/
...
bool CISMEditorProject::RodarCubo(CIMTVetor EixoRotacao)
{
    /******************************************/
    /*Neste exemplo não há nenhuma atualização*/
    /******************************************/
