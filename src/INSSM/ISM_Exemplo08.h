...
/*Descricao           :Exemplo de Utilização de Scripts Lua na INS3D
/*Data de Criação     :
/*
/*Copyright (c) 2013 William Wolff. Todos os direitos reservados
/**********************************************************************************/
#ifndef CISMEXEMPLO08_H
#define CISMEXEMPLO08_H

#include "ISM_Cenario.h"
#include "IUT_Lista.h"


class CISMExemplo08 : public CISMCenario
{
private:
...
public:
     CISMExemplo08(QOpenGLContext   *pI3DContext);
     CISMExemplo08(QGLContext       *pI3DContext);
    ~CISMExemplo08(                             );
