...
CISMExemplo01::CISMExemplo01(QOpenGLContext *pI3DContext):
...
CISMExemplo01::CISMExemplo01(QGLContext *pI3DContext):
    CISMCenario(pI3DContext)
{
    japosicionou          =false;
...
CISMExemplo01::~CISMExemplo01()
{
    delete pCubo;
}

bool CISMExemplo01::Inicializa()
{
    /***********************************************/
    /*Cria a Camera                                */
    /***********************************************/
...
bool CISMExemplo01::Render(float pTimeElapsed)
{
    /*******************************************************************/
...
bool CISMExemplo01::Resize(int w, int h)
{
    /*****************************/
...
bool CISMExemplo01::MapeiaMouse(int x, int y)
{
    pCam->MapeiaMouse((float)x ,(float)y);
    return true;
}

bool CISMExemplo01::MoverCamera(int pAction)
{
    /****************************************/
...
bool CISMExemplo01::InputKey(int pKey)
{
    /****************************************/
    /*Processa as teclas pressionadas       */
    /****************************************/
...
bool CISMExemplo01::SetIniPos(CI3DCamera *pCam, CIMTVetor centro)
{
    CIMTVetor posicao;
...
bool CISMExemplo01::AtualizaCena()
{
    /******************************************/
